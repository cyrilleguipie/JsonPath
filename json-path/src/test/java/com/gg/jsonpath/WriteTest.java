...
public class WriteTest extends BaseTest {
    ...
    public void an_array_child_property_can_be_updated() {
        ...
        Object o = JsonPath.parse(JSON_DOCUMENT).set("$.store.book[*].display-price", 1).json();
    ...
    public void an_root_property_can_be_updated() {
        ...
        Object o = JsonPath.parse(JSON_DOCUMENT).set("$.int-max-property", 1).json();
    ...
    public void an_deep_scan_can_update() {
        ...
        Object o = JsonPath.parse(JSON_DOCUMENT).set("$..display-price", 1).json();
    ...
    public void an_filter_can_update() {
        ...
        Object o = JsonPath.parse(JSON_DOCUMENT).set("$.store.book[?(@.display-price)].display-price", 1).json();
    ...
    public void a_path_can_be_deleted() {
        ...
        Object o = JsonPath.parse(JSON_DOCUMENT).delete("$.store.book[*].display-price").json();
    ...
    public void operations_can_chained() {
        ...
        Object o = JsonPath.parse(JSON_DOCUMENT)
    ...
    public void an_array_index_can_be_updated() {
        ...
        String res = JsonPath.parse(JSON_DOCUMENT).set("$.store.book[0]", "a").read("$.store.book[0]");
    ...
    public void an_array_slice_can_be_updated() {
        ...
        List<String> res = JsonPath.parse(JSON_DOCUMENT).set("$.store.book[0:2]", "a").read("$.store.book[0:2]");
    ...
    public void an_array_criteria_can_be_updated() {
        ...
        List<String> res = JsonPath.parse(JSON_DOCUMENT)
    ...
    public void multi_prop_delete() {
        ...
        List<Map<String, Object>> res = JsonPath.parse(JSON_DOCUMENT).delete("$.store.book[*]['author', 'category']").read("$.store.book[*]['author', 'category']");
    ...
    public void multi_prop_update() {
        ...
        List<Map<String, Object>> res = JsonPath.parse(JSON_DOCUMENT).set("$.store.book[*]['author', 'category']", "a").read("$.store.book[*]['author', 'category']");
    ...
    public void multi_prop_update_not_all_defined() {
        ...
        List<Map<String, Object>> res = JsonPath.parse(JSON_DOCUMENT).set("$.store.book[*]['author', 'isbn']", "a").read("$.store.book[*]['author', 'isbn']");
    ...
    public void add_to_array() {
        Object res = JsonPath.parse(JSON_DOCUMENT).add("$.store.book", 1).read("$.store.book[4]");
        assertThat(res).isEqualTo(1);
    }

    @Test
    public void add_to_object() {
        Object res = JsonPath.parse(JSON_DOCUMENT).put("$.store.book[0]", "new-key", "new-value").read("$.store.book[0].new-key");
    ...
    public void add_to_object_on_array() {
        JsonPath.parse(JSON_DOCUMENT).put("$.store.book", "new-key", "new-value");
    }

    @Test(expected = InvalidModificationException.class)
    public void add_to_array_on_object() {
        JsonPath.parse(JSON_DOCUMENT).add("$.store.book[0]", "new-value");
    }
    ...
    public void a_path_can_be_renamed(){
        Object o = JsonPath.parse(JSON_DOCUMENT).renameKey("$.store", "book", "updated-book").json();
    ...
    public void keys_in_root_containing_map_can_be_renamed(){
        Object o = JsonPath.parse(JSON_DOCUMENT).renameKey("$", "store", "new-store").json();
    ...
    public void map_array_items_can_be_renamed(){
        Object o = JsonPath.parse(JSON_DOCUMENT).renameKey("$.store.book[*]", "category", "renamed-category").json();
    ...
    public void multiple_properties_cannot_be_renamed(){
        JsonPath.parse(JSON_DOCUMENT).renameKey("$.store.book[*]['author', 'category']", "old-key", "new-key");
    }

    @Test(expected = PathNotFoundException.class)
    public void non_existent_key_rename_not_allowed(){
        Object o = JsonPath.parse(JSON_DOCUMENT).renameKey("$", "fake", "new-fake").json();
    }
    ...
    public void rootCannotBeMapped(){
        ...
        Object o = JsonPath.parse(JSON_DOCUMENT).map("$", mapFunction).json();
    }

    @Test
    public void single_match_value_can_be_mapped(){
        MapFunction mapFunction = new ToStringMapFunction();
        String stringResult = JsonPath.parse(JSON_DOCUMENT).map("$.string-property", mapFunction).read("$.string-property");
    ...
    public void multi_match_path_can_be_mapped(){
        MapFunction mapFunction = new ToStringMapFunction();
        List<Double> doubleResult = JsonPath.parse(JSON_DOCUMENT).read("$..display-price");
        for(Double dRes : doubleResult){
            assertThat(dRes).isInstanceOf(Double.class);
        }
        List<String> stringResult = JsonPath.parse(JSON_DOCUMENT).map("$..display-price", mapFunction).read("$..display-price");
