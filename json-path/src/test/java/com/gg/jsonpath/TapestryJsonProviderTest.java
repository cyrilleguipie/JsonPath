...
public class TapestryJsonProviderTest extends BaseTest {
  ...
  public void an_object_can_be_read() {
    ...
    JSONObject book = JsonPath.using(TAPESTRY_JSON_CONFIGURATION).parse(JSON_DOCUMENT).read("$.store.book[0]");
  ...
  public void a_property_can_be_read() {
    ...
    String category = JsonPath.using(TAPESTRY_JSON_CONFIGURATION).parse(JSON_DOCUMENT).read("$.store.book[0].category");
  ...
  public void a_filter_can_be_applied() {
    ...
    JSONArray fictionBooks = JsonPath.using(TAPESTRY_JSON_CONFIGURATION).parse(JSON_DOCUMENT)
  ...
  public void result_can_be_mapped_to_object() {
    ...
    List<Map<String, Object>> books = JsonPath.using(TAPESTRY_JSON_CONFIGURATION).parse(JSON_DOCUMENT).read("$.store.book",
        List.class);
