...
import com.gg.jsonpath.spi.transformer.*;
import com.gg.jsonpath.spi.transformer.jsonpathtransformer.model.LookupTable;
import com.gg.jsonpath.spi.transformer.jsonpathtransformer.model.SourceTransform;
import com.jayway.jsonpath.*;
import com.jayway.jsonpath.spi.transformer.*;
import com.gg.jsonpath.spi.transformer.jsonpathtransformer.model.PathMapping;
import com.gg.jsonpath.spi.transformer.jsonpathtransformer.model.TransformationModel;
...
import static com.gg.jsonpath.spi.transformer.jsonpathtransformer.model.JsonPathTransformerValidationError.*;
...
public class JsonPathTransformationProvider implements TransformationProvider<JsonPathTransformationSpec> {
        ...
        for (PathMapping pm : model.getPathMappings()) {
            ...
            if (srcPath != null) {
                ...
                if (!compiledSrcPath.isDefinite() && !compiledDstPath.isDefinite()
                        && JsonPathTransformationSpec.isArrayWildCard(pm.getSource()) && JsonPathTransformationSpec.isArrayWildCard(pm.getTarget())) {
    ...
    private Object transform(PathMapping pm,
        ...
        if (!JsonPathTransformationSpec.isScalar(srcValue)) {
